...
class AddEditNoteActivity : AppCompatActivity() {
    companion object {
        const val EXTRA_ID = "com.examples.myapplication.EXTRA_ID"
        const val EXTRA_JUDUL = "com.examples.myapplication.EXTRA_JUDUL"
        const val EXTRA_DESKRIPSI = "com.examples.myapplication.EXTRA_DESKRIPSI"
        const val EXTRA_NOMER = "com.examples.myapplication.EXTRA_NOMER"
        const val EXTRA_PRIORITAS = "com.examples.myapplication.EXTRA_PRIORITAS"
    }
